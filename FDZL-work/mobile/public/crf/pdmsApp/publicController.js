...
//var path = 'http://alan.natapp1.cc/'
//var path = 'http://192.168.10.152:12003/';
//var path = 'http://192.168.10.156:12004/portal/';
...
function visitPick(arry) {
  ...
  visitTypeName.addEventListener('tap', (event) => {
    visitPick.show((items) => {
...
function noData() {
	var str = '';
	str += '<div class="textCenter" style="background-color:#ddeaf0;">';
